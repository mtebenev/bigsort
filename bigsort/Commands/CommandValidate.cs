...
namespace BigSort.Commands
{
  ...
  /// </summary>
  [Command(Name = "validate", Description = @"The command validates sorted files using sqlite database (cross-validation).
...
Warning! This command is very slow, use for development purposes only.
")]
